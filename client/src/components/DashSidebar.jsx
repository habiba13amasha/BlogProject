        ...
        <Sidebar.Items>
            <Sidebar.ItemGroup className="flex flex-col gap-1">
                <Link to="/dashboard?tab=profile">
                  <Sidebar.Item active={tab==="profile"} icon={HiUser} label={currentUser.isAdmin?"Admin" :"User"} labelColor="dark" className="py-1" as="div">Profile</Sidebar.Item>
                </Link>
                {currentUser.isAdmin&&
                <>
                  ...
                  <Link to="/dashboard?tab=comments">
                    <Sidebar.Item active={tab==="users"} icon={HiAnnotation}  as="div">Comments</Sidebar.Item>
                  </Link>
                </>
                }
